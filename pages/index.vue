            ...
            reviews: [
                {
                    ...
                    text2: 'Аналитик предоставил нам инсайды, которые помогли нам принимать обоснованные решения. Он был легко доступен для обсуждения результатов анализа и дал нам уверенность в наших действиях',
