<template>
    <div class="catalog">
        <h1>Каталог экспертов</h1>

        <div class="catalog__filters">
            <p>Разнообразие экспертных услуг для ваших запросов</p>
            <div class="buttons">
            ...
            <div class="sort__body" :class="{ activeBlock: sort }">
                ...
                <span @click="activeSort = 2, sortBy('-price')" :class="{ activeSpan: activeSort == 2 }">Сначала
                    дороже</span> -->
                <span @click="activeSort = 3, sortBy('-user__date_joined')" :class="{ activeSpan: activeSort == 3 }">Самые
                    новые</span>
                <span @click="activeSort = 4, sortBy('user__date_joined')" :class="{ activeSpan: activeSort == 4 }">Самые
                    старые</span>
                <span @click="activeSort = 5, sortBy('-rating')" :class="{ activeSpan: activeSort == 5 }">Самые
                    популярные</span>
            </div>
